...
function main(
    ...
    max_feature_width, max_feature_height, min_feature_height, min_feature_width = (-1, -1, 1, 1)
    ...
    data_file = joinpath(dirname(@__DIR__), "data", "classifiers_$(num_classifiers)_from_$(num_pos)_pos_$(num_neg)_neg_($(join(scale_to, ',')))_($max_feature_width,$max_feature_height,$min_feature_height,$min_feature_width)")
