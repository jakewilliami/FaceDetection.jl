...
function main(
    ...
    face_scores       = Float64[get_faceness(classifiers, load_image(img, scale=scale, scale_to=scale_to)) for img in face_testing_images]
    pareidolia_scores = Float64[get_faceness(classifiers, load_image(img, scale=scale, scale_to=scale_to)) for img in pareidolia_testing_images]
    flower_scores     = Float64[get_faceness(classifiers, load_image(img, scale=scale, scale_to=scale_to)) for img in flower_testing_images]
    ...
    for (image_type, image_names, image_scores) in ((FACE, face_names, face_scores), (PAREIDOLIA, pareidolia_names, pareidolia_scores), (FLOWER, flower_names, flower_scores), (OBJECT, object_names, object_scores))
    ...
    StatsPlots.savefig(plot, joinpath(dirname(@__DIR__), "figs", "faceness_of_faces_versus_objects.pdf"))
    @info("...done.  Plot created at $(joinpath(dirname(@__DIR__), "figs", "faceness_of_faces_versus_objects.pdf"))")
    ...
    StatsPlots.savefig(plot, joinpath(dirname(@__DIR__), "figs", "faceness_of_pareidolia_versus_objects.pdf"))
    @info("...done.  Plot created at $(joinpath(dirname(@__DIR__), "figs", "faceness_of_pareidolia_versus_objects.pdf"))")
    ...
    StatsPlots.savefig(plot, joinpath(dirname(@__DIR__), "figs", "faceness_of_faces_versus_flowers.pdf"))
    @info("...done.  Plot created at $(joinpath(dirname(@__DIR__), "figs", "faceness_of_faces_versus_flowers.pdf"))")
    ...
    StatsPlots.savefig(plot, joinpath(dirname(@__DIR__), "figs", "faceness_of_pareidolia_versus_flowers.pdf"))
    @info("...done.  Plot created at $(joinpath(dirname(@__DIR__), "figs", "faceness_of_pareidolia_versus_flowers.pdf"))")
end
